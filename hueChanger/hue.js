...
buttonDiv.addEventListener('click', (e) => {
    ...
    if (checkbox.checked) {
        colorsExport[1][5] = colorsExport[1][0] //save previous color in memory
        colorsExport[1][0] = 'hsl(0, 0%, 13%)'//new black mode color
        colorsExport[1][3] = 'hsl(0, 0%, 86%)'
        colorsExport[1][4] = 'invert()'

    }
    else { 
        colorsExport[1][3] = 'hsl(0, 0%, 13%)'
